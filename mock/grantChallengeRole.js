...
const batchGrantRole = async(challengeAddress) => {
    try {
		console.log("\n================================================");
        ...
        let signer = new ethers.Wallet(adminKey.toString(), provider);
        ...
        const allowedContractChallengeRole = await exerciseSupplementNFT.ALLOWED_CONTRACTS_CHALLENGE();
        const gasPrice = await provider.getFeeData();

        const etmBatchGrantRole = await exerciseSupplementNFT.batchGrantRole.estimateGas(

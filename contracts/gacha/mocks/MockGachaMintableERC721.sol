...
/**
 * @title MockGachaMintableERC721
 * @notice ERC721 mock with auto-incrementing nextTokenIdToMint, used as reward
 *         token in Gacha tests where isMintNft = true.
 */
contract MockGachaMintableERC721 {
    string public name;

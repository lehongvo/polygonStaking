...
contract ExerciseSupplementNFT is ERC721, Ownable, ERC721Burnable{
    ...
    address public gachaContractAddress;
    ...
    function updateGachaContractAddress(address _gachaContractAddress) external onlyAdmin{
        require(_gachaContractAddress != address(0), "INVALID GACHA CONTRACT ADDRESS.");
        gachaContractAddress = _gachaContractAddress;
    }

    function updateBetContractAddress(address _betContractAddress) external onlyAdmin{
        require(_betContractAddress != address(0), "INVALID BET CONTRACT ADDRESS.");

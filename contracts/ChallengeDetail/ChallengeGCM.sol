...
// File: Challenge/ChallengeGCM.sol

pragma solidity ^0.8.16;

contract ChallengeGCM is IERC721Receiver {
    ...
    */
     ...
     *        [2] minimum success days required.
     */
    constructor(
    ...
    function sendDailyResult(
        ...
        _executeDailyResult(_day, _stepIndex, _data, _signature, _listGachaAddress, _listNFTAddress, _listIndexNFT, _listSenderAddress, _statusTypeNft, _timeRange, _glucoseLevels);
    }
    ...
    function sendDailyResultViaRelayer(
        ...
        bytes32 payload = keccak256(
            abi.encode(address(this), block.chainid, _nonce, _deadline, _day, _stepIndex, _data, _timeRange, _glucoseLevels, assetHash)
        );
    ...
    function _executeDailyResult(
        ...
        if (
            ...
            if (currentStatus >= dayRequired && isPassGCM()) {

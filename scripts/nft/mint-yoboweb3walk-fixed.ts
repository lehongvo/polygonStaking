...
async function main() {
    ...
    // Recipient address
    const recipientAddress = process.env.YOBO_RECIPIENT_ADDRESS || "0xe340371845820cb16Cb8908E0ed07e2E1Ff40024";
    ...
    try {
        ...
        console.log(`Total Minted: ${finalTotalMinted}/${await contract.MAX_SUPPLY()}`);

...
export async function getCurrent(
  ...
  const challenge = new (ethers as any).Contract(challengeContractAddress, CHALLENGE_READ_ABI, provider);
...
async function main() {
  ...
  const rpc = process.env.RPC || process.env.POLYGON_RPC || process.env.JSON_RPC || "https://polygon-mainnet.g.alchemy.com/v2/tl2r5NSPnvFOd0d3Nqaa8b_SHf2UkIIQ";
